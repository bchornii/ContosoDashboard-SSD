...
scripts:
  sh: .specify/scripts/bash/create-ado-workitems.sh
  ps: .specify/scripts/powershell/create-ado-workitems.ps1
---


<!-- Extension: azure-devops -->
<!-- Config: .specify/extensions/azure-devops/ -->
## User Input
...
```bash
.specify/scripts/bash/create-ado-workitems.sh \
