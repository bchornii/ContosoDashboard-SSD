    ...
    public partial class AddDocumentTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentActivityLogs", x => x.ActivityLogId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DocumentActivityLogs_Users_ActorUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(3950), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(3956), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(3960), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(3965), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 5, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4500), true, new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4499), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 3, 30, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4232), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 3, 30, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4216), 1, new DateTime(2026, 6, 28, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4226), new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4237) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 30, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4348), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 3, 30, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4352), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 3, 30, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4286), "Create entity relationship diagram and database design", new DateTime(2026, 4, 9, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4283), 2, 1, 2, "Design database schema", new DateTime(2026, 4, 9, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4287) },
                    { 2, 4, 2, new DateTime(2026, 4, 4, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4294), "Set up Microsoft Entra ID authentication", new DateTime(2026, 5, 4, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4292), 3, 1, 1, "Implement authentication", new DateTime(2026, 4, 29, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4295) },
                    { 3, 4, 2, new DateTime(2026, 4, 9, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4300), "Design user interface mockups for all main pages", new DateTime(2026, 5, 9, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4298), 1, 1, 0, "Create UI mockups", new DateTime(2026, 4, 9, 14, 39, 58, 12, DateTimeKind.Utc).AddTicks(4301) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentActivityLogs_ActorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentActivityLogs_OccurredAt",
                table: "DocumentActivityLogs",
                column: "OccurredAt");
